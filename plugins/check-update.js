...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://github.com/prince009here/ADEEL-MD/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/prince009here/ADEEL-MD/archive/main.zip", { responseType: "arraybuffer" });
